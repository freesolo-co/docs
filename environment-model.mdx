...
from reward scores), **and eval**. You don't restate your task per algorithm;
you swap one line in the config and the environment stays put.
...
The environment is the entirety of what makes a run _yours_. The quality of its
dataset and reward sets the ceiling on what training can achieve. For the full
split of responsibilities, see
