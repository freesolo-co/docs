...
Record OpenAI-compatible calls with your own provider keys, then export ready-to-train datasets from the dashboard or Flash CLI.
...
Run larger training jobs across multiple GPUs with managed provisioning and pricing.

**New · Training**

## Per-turn or per-episode credit for multi-turn GRPO

Choose whether rewards apply to individual turns or the complete rollout.
