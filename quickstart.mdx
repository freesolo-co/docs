...
<Accordion title="Already have a training loop?" icon="robot">
  ...
  the [environment guide](/guides/environments) and have it find and port your
...
project, then read https://freesolo.mintlify.app/guides/environments and
...
configs/ (grpo.toml for GRPO, sft.toml for SFT) with the base model and
[train] settings.
```
