...
On-policy distillation has the managed GLM 5.2 teacher grade your model's own
completions token by token, then pulls your model toward it. Use it when a bigger
