...
```bash
flash env pull your-name/your-env datasets/train.jsonl -o train.jsonl
```
...
```bash
flash env delete your-name/your-env
flash env delete your-name/your-env -y   # skip the confirmation prompt
```
