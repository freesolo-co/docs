...
- **In training** — constrain every GRPO or OPD rollout so your reward measures the
  answer's _content_ instead of penalizing malformed wrappers.
- **At serving:** constrain the final answer after any reasoning closes. Give
  the request enough output tokens and check `finish_reason` for truncation.
