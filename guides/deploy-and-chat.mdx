...
rates, and cached prompt tokens use the model's cached-input rate. Listed prices
include Freesolo's 1.2 serving markup over typical provider rates. See the
actual prices in [Supported models](/reference/models#serving-prices).
