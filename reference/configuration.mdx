...
| `algorithm` | string | `grpo` | `grpo` (RL): learns from a reward you define. `sft` (supervised): learns by imitating example completions you provide. See [SFT vs GRPO](/guides/training#choose-sft-or-grpo). |
