...
<Note>
  Flash's public training and chat flows are text-focused. Some catalog checkpoints
  are natively multimodal; serving keeps the full base modules needed for adapter
  compatibility, but the documented Flash workflow is still text tasks and text
  chat requests.
</Note>
...
as LoRA slots on that tier. The smaller catalog models serve on Modal L4
instances; the 35B model serves on an A100-80GB tier.

| Model | Serving GPU | Served context | Hot LoRA slots |
| --- | --- | ---: | ---: |
| `Qwen/Qwen3.5-0.8B` | L4 | 8192 | 16 |
| `openbmb/MiniCPM5-1B` | L4 | 8192 | 16 |
| `Qwen/Qwen3.5-2B` | L4 | 8192 | 16 |
| `Qwen/Qwen3.5-4B` | L4 | 8192 | 16 |
| `Qwen/Qwen3.5-9B` | L4 | 8192 | 16 |
| `Qwen/Qwen3.6-35B-A3B` | A100-80GB | 4096 | 6 |
