...
max rank, is rejected. Every model is _served_ at a 32768-token context, and the
training cap equals that for every model except `Qwen/Qwen3.6-35B-A3B`, which
trains at up to 4096 tokens but is still served at 32768.
