...
at submit: a config whose `max_length` (or GRPO rollout length) exceeds the served
context, or whose `lora_rank` exceeds the cap, is rejected.

| Model | Context window | Max LoRA rank |
| --- | ---: | ---: |
| `Qwen/Qwen3.5-0.8B` | 8192 | 128 |
| `openbmb/MiniCPM5-1B` | 8192 | 128 |
| `Qwen/Qwen3.5-2B` | 8192 | 128 |
| `Qwen/Qwen3.5-4B` | 8192 | 64 |
| `Qwen/Qwen3.5-9B` | 8192 | 64 |
