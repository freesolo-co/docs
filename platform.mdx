...
A new organization starts with a project called `Example`, holding a starter
...
Starter credit comes in two tiers, \$60 in total, each claimed once from billing
settings: \$10 with no payment method at all, and a further \$50 once a card is on
file. Adding a card does not credit your balance on its own. Manual top-ups range
from \$50 to \$10,000.
