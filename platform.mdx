...
environments, and recorded traces each belong to a project, and the navigation
is scoped to the project you have open. New work lands in your org's
**Default** project unless you assign one, from the dashboard, with
`flash env push --project`, or with the top-level `project` field in a
[training config](/reference/configuration#top-level).
