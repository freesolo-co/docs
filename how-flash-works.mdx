...
OpenAI-compatible API. Reach for post-training when you want consistent behavior,
...
the frozen base model. This is _parameter-efficient_ fine-tuning, and it has
